    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'       =>  esc_html__( 'Title About Text', 'getdesign' ),
                'label_block'   =>  true
            ]
        );
        ...
        $this->start_controls_section(
            'section_text_editor',
            [
                'label' => esc_html__( 'Text Editor', 'getdesign' ),
            ]
        );
        ...
        $this->add_control(
            'title_color',
            [
                'label'     =>  __( 'Title Color', 'getdesign' ),
        ...
        $this->add_control(
            'text_editor_color',
            [
                'label'     =>  __( 'Text Editor Color', 'getdesign' ),
                'type'      =>  Controls_Manager::COLOR,
                'selectors' =>  [
        ...
        $this->add_control(
            'hide_line',
            [
                'label'     =>  esc_html__( 'Hide Line', 'getdesign' ),
                'type'      =>  Controls_Manager::SELECT,
                'default'   =>  'no',
                'options'   =>  [
                    'no'    =>  esc_html__( 'No', 'getdesign' ),
                    'yes'   =>  esc_html__( 'Yes', 'getdesign' ),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'margin_bottom_line',
            [
                'label'     =>  esc_html__( 'Margin Bottom Line', 'getdesign' ),
