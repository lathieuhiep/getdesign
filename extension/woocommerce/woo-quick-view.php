...
*/
function getdesign_button_quick_view() {

?>

    <a class="btn-quick-view-product" href="#" title="<?php esc_attr_e( 'Quick view product', 'getdesign' ); ?>" data-id-product="<?php echo esc_attr( get_the_ID() ); ?>">
...
function getdesign_popup_quick_view_product() {
...
add_action( 'wp_ajax_nopriv_getdesign_get_quick_view_product', 'getdesign_get_quick_view_product' );
add_action( 'wp_ajax_getdesign_get_quick_view_product', 'getdesign_get_quick_view_product' );

function getdesign_get_quick_view_product() {
